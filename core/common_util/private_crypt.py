...
import my_config.com_config as com_config
import logging
...
def get_aes_key():
    ...
    :return:
    """
    private_key = com_config.PRIVATE_AES_KEY  # 你的私钥
    if private_key is None:
        logging.error("!!!!com_config.py中PRIVATE_AES_KEY(AES的私钥)")
        raise ValueError('PRIVATE_AES_KEY(AES的私钥)未配置')
